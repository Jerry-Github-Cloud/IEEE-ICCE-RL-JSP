...
def solve(file_name, time_limit, num_thread=8, verbose=False, export=False):
    result = []
    ...
    # solution printer
    printer = cp_model.VarArrayAndObjectiveSolutionPrinter([makespan_var, tardiness_var])
...
if __name__ == '__main__':
    ...
    # file_name = "abz5"
    # time_limit = 60
    # solve(file_name, time_limit, verbose=False, export=False)
